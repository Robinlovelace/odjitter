...
od_top3_road = od::od_disaggregate(odsf_top3, z = zones, road_network_min, max_per_od = 1000)
od_top3_disaggregated = od::od_disaggregate(odsf_top3, z = zones, road_network_min, max_per_od = 100)
m1 = tm_shape(odsf_top3, bbox = bbox) +
  tm_lines("foot", palette = "Set1", breaks = c(100, 200, 300, 400), lwd = 6) +
  tm_shape(zones) +
  tm_borders() +
...
m4 = tm_shape(road_network_min, bbox = bbox) +
  ...
  tm_lines("foot", palette = "Set1", lwd = 6, breaks = c(0, 60, 70, 80)) +
  # tm_shape(zones) +
  # tm_borders()  +
