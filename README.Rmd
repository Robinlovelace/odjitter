...
We found that the process of jittering can generate desire lines that have more widely distributed, and potentially realistic, start and end points.
...
od_top3_jittered = od::od_jitter(od_sf_100, z = zones)
od_top3_road = od::od_jitter(od_sf_100, z = zones, road_network_buffer, max_per_od = 1000)
od_top3_disaggregated = od::od_jitter(od_sf_100, z = zones, road_network_buffer, max_per_od = 200)
# od_top3_disaggregated = od::od_jitter(od_sf_100, z = zones, road_network_min, max_per_od = 200, population_column = "foot")
m1 =  tm_shape(zones, bbox = bbox) +
  tm_borders(col = "grey") +
  tm_shape(od_sf_100, bbox = bbox) +
  tm_lines(lwd = "foot", scale = 3) +
