...
- And can further refinements, for example sampling with weights to increase the proportion of trips associated with large buildings, or modifying disaggregation threshold values depending on variables such as zone size, yield further benefits? 
