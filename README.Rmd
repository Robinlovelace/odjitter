...
od_top3_disaggregated = od::od_jitter(odsf_top3, z = zones, road_network_min, max_per_od = 100)
...
od_combined = rbind(
  odsf_top3 %>% transmute(foot, type = fn[1]),
...
od_sf_disaggregated = od::od_jitter(od_sf_100, z = zones, road_network_buffer, max_per_od = 100)
...
rnets_summary %>% knitr::kable(booktabs = TRUE, digits = 0)
```
