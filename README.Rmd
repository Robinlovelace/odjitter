...
We found that jittering generates desire lines that are more geographically diffuse than desire lines resulting from the common method of using zone centroids to represent start and end points (Figure \@ref(fig:jittered514)).
This demonstrates the use of simple random sampling and sampling nodes on transport networks with reference to a real world example.
