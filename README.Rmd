...
In this paper we present a new approach to pre-processing OD datasets before route network generation that we refer to as 'jittering', following the use of the term to describe a similar process of adding "random noise to the data" for data visualization [@wickham_2016_ggplot2].
