...
In this paper we present a new approach to pre-processing OD datasets before route network generation that we refer to as 'jittering'.
...
It is, to the best of our knowledge, the first paper focussed on the two step process of jittering described in this paper --- sampling origin and destination points (with simple random sampling or by sampling from the nodes on the network) and disagreggation --- supported with a reproducible implmentation based on open source software (see accompanying code).
