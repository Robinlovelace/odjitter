...
m3 = tm_shape(road_network_min, bbox = bbox) +
  ...
  tm_lines("foot", palette = "Set1", breaks = c(100, 200, 300, 400), lwd = 6) +
  tm_layout(title = "C) Randomised points sampled from transport network", title.bg.color =  "white")

m4 = tm_shape(od_top3_disaggregated, bbox = bbox) +
  tm_lines("foot", palette = "Set1", lwd = 6, breaks = c(0, 50, 60, 70, 80)) +
  tm_shape(zones) +
  tm_borders()  +
  tm_layout(title = "D) Jittered result with disaggregation and points on network", title.bg.color =  "white")
